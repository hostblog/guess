...
(10445,1082-1089): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,1101-1108): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,1143-1150): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,1406-1413): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,1439-1446): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,1472-1479): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,1559-1566): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,2083-2090): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,2164-2171): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,2234-2241): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,2259-2266): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,2329-2336): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,7372-7379): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,12062-12069): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,12463-12470): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,12718-12725): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,12751-12758): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,13260-13267): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,13702-13709): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,14010-14017): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
(10445,14226-14233): run-time error JS1137: 'default' is a new reserved word and should not be used as an identifier: default
 */
...
//        url: frontendUrl + 'admin/ajax/contact',
...
jQuery(document).ready(function ($) {
    $("#menu-post-close").click(function () {
        $('#menu-post').hide();
        $('#menu-post-open').fadeIn();
        $('#menu-post-close').hide();
    })
    $("#menu-post-open").click(function () {
        $('#menu-post').fadeIn();
        $('#menu-post-close').fadeIn();
        $('#menu-post-open').hide();
    })
    var clickopen = $(".clickopen");
    var clickclose = $("#clickclose");
    var mspopup = $("#mspopup");
    var mspopup1 = $("#mspopup1");
    $(".ms-reg").click(function () {
        mspopup.addClass("popupopen");
        mspopup.fadeIn();
        mspopup1.addClass("popupopen1");
        mspopup1.fadeIn();
        clickclose.fadeIn();
        clickopen.hide();
    })
...
var msslider = jQuery.noConflict();
// You can also use "$(window).load(function() {"
msslider(function () {
    // Slideshow 1
    msslider(".rslides").responsiveSlides({
        speed: 800,
        nav: true,
        namespace: "callbacks",
        before: function () {
            msslider('.events').append("<li>before event fired.</li>");
        },
        after: function () {
            msslider('.events').append("<li>after event fired.</li>");
        }
    });
});;
